      ...
      const candyGuardMintInstruction = createMintInstruction(
        {
          ...
          candyMachineAuthorityPda: web3.PublicKey.default,
          payer: args.wallet,
          nftMetadata: web3.PublicKey.default,
          nftMint: web3.PublicKey.default,
          nftMintAuthority: web3.PublicKey.default,
          nftMasterEdition: web3.PublicKey.default,
          collectionAuthorityRecord: web3.PublicKey.default,
          collectionMint: web3.PublicKey.default,
          collectionMetadata: web3.PublicKey.default,
          collectionMasterEdition: web3.PublicKey.default,
          collectionUpdateAuthority: web3.PublicKey.default,
          tokenMetadataProgram: web3.PublicKey.default,
          recentSlothashes: web3.PublicKey.default,
