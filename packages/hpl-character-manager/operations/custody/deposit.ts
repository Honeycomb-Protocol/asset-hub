 ...
 * @category Types
 */
type CreateDepositAssetOperationArgs = {
  asset: Asset;
 ...
 * const operationArgs: CreateDepositNftOperationArgs = {
 *   args: mintPublicKey ? { mint: mintPublicKey } : depositNftArgs,
 *   project,
 * };
 * const { operation } = await createDepositNftOperation(honeycomb, operationArgs);
 * operation.send();
 */
export async function createDepositAssetOperation(
  honeycomb: Honeycomb,
  args: CreateDepositAssetOperationArgs
) {
