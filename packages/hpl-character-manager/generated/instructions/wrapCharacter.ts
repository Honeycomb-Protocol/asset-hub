 ...
 * @category WrapCharacter
 * @category generated
 */
export const wrapCharacterStruct = new beet.BeetArgsStruct<{
  instructionDiscriminator: number[] /* size: 8 */
}>(
  [['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)]],
  'WrapCharacterInstructionArgs'
)
/**
 * Accounts required by the _wrapCharacter_ instruction
 *
 * @property [] project
 ...
 * @category generated
 */
export type WrapCharacterInstructionAccounts = {
...
export const wrapCharacterInstructionDiscriminator = [
  195, 170, 196, 81, 245, 147, 14, 8,
]

/**
 * Creates a _WrapCharacter_ instruction.
 *
