...
export declare function createBurnNFTTransaction(assembler: web3.PublicKey, nft: web3.PublicKey, nftMint: web3.PublicKey, authority: web3.PublicKey, programId?: web3.PublicKey): TxSignersAccounts;
