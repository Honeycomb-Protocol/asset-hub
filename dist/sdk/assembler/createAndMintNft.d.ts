...
export declare function buildCreateAndMintNftCtx({ mx, assembler, args, blocks, }: CreateAndMintNftArgs): Promise<{
    txns: TxSignersAccounts[];
    nft: web3.PublicKey;
    nftMint: web3.PublicKey;
}>;
export declare function createAndMintNft({ mx, assembler, args, blocks, }: CreateAndMintNftArgs): Promise<{
    response: Promise<import("@metaplex-foundation/js").SendAndConfirmTransactionResponse>;
    nftMint: web3.PublicKey;
    nft: web3.PublicKey;
}>;
