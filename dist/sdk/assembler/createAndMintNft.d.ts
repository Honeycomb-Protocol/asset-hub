...
export declare function createMintNftTransaction(assembler: web3.PublicKey, nftMint: web3.PublicKey, uniqueConstraint: web3.PublicKey | null, authority: web3.PublicKey, payer: web3.PublicKey, programId?: web3.PublicKey): TxSignersAccounts;
export declare function getUniqueConstraintPda(blocks: CreateAndMintNftArgs["blocks"]): web3.PublicKey;
