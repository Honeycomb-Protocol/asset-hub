...
export declare function createMintNftTransaction(assembler: web3.PublicKey, collectionMint: web3.PublicKey, nftMint: web3.PublicKey, authority: web3.PublicKey, payer: web3.PublicKey, programId?: web3.PublicKey): TxSignersAccounts;
