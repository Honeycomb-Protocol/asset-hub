...
exports.initStaker = exports.createInitStakerTransaction = void 0;
const web3 = __importStar(require("@solana/web3.js"));
const generated_1 = require("../../generated");
const staking_1 = require("../../generated/staking");
function createInitStakerTransaction(project, wallet, programId = staking_1.PROGRAM_ID) {
    const [staker] = web3.PublicKey.findProgramAddressSync([Buffer.from("staker"), wallet.toBuffer(), project.toBuffer()], programId);
    const instructions = [
        (0, generated_1.createInitStakerInstruction)({
            project,
            staker,
            wallet,
        }, programId),
...
exports.createInitStakerTransaction = createInitStakerTransaction;
async function initStaker(mx, project) {
