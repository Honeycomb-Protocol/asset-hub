...
export declare const createV0TxWithLUT: (mx: Metaplex, lookupTableAddress: web3.PublicKey, ...txInstructions: web3.TransactionInstruction[]) => Promise<web3.VersionedTransaction>;
export declare const createLookupTable: (mx: Metaplex, addresses: web3.PublicKey[]) => Promise<web3.PublicKey>;
